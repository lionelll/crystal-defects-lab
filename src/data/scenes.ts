...
export const scenes: SceneInfo[] = [
  ...
  { id: 'screw', module: 'model', title: '螺型位错', subtitle: '晶面绕位错线产生螺旋错移', relation: 'b ∥ L · 多个包含 L 的候选滑移面', result: '螺型位错是晶格的螺旋错移，不是一根孤立的螺旋线。', observe: ['从顶面观察绕芯的原子层高度。', '若未显示，打开“表面台阶”，旋转至侧面观察金色台阶与滑移分界。', '比较 b 与 L 的平行关系。'], stages: ['结构观察'], animated: false },
  { id: 'edge-glide', module: 'motion', title: '刃型位错滑移', subtitle: '位错沿原滑移面前进', relation: 'L ∥ z · b ∥ x · 滑移面 xz', result: '位错扫过的区域逐步产生相对错动。', observe: ['用“切应力”开关，比较紫色应力箭头与青绿色运动路径。', '位错线沿 x 方向推进，已滑过区域扩大。', '比较晶体两侧的相对错动。'], stages: ['滑移起始', '沿面滑移', '错动形成'], animated: true },
  ...
  { id: 'frank-read', module: 'multiplication', title: 'Frank–Read 源', subtitle: '固定端之间连续生成位错环', relation: '两端固定 · 弓出与环位于同一滑移面', result: '固定段弓出、相遇、脱离后，源段可再次工作。', observe: ['A、B 两端固定；用“切应力”开关可查看紫色受力箭头。', '线越过半圆后继续弓出并相遇。', '闭合环扩张，源线恢复并再次弓出。'], stages: ['固定源段', '受力弓出', '首个环脱离', '源线再次弓出', '第二个环生成'], stageThresholds: [.05, .385, .55, .865], animated: true },
